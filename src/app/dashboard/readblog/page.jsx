                    ...
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-6xl mt-10 relative">
                        ...
                        <div className="absolute top-3 right-3 flex space-x-3">
                            ...
                            <button
                                ...
                                className={`w-10 h-10 flex items-center justify-center rounded-full bg-red-500 hover:bg-red-600 text-white shadow transition-all focus:outline-none ${deleteLoading ? "cursor-not-allowed opacity-70" : ""
                                    }`}
                                title="Delete Blog"
